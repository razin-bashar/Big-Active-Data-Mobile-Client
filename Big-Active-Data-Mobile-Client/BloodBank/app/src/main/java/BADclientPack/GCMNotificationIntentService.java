...
//package com.example.razin.gcminstall;
        ...
        import com.example.root.bloodbank.R;
        import com.example.root.bloodbank.automatic_show_service;
        import com.example.root.bloodbank.data;
        import com.google.android.gms.gcm.GoogleCloudMessaging;

        import java.util.List;

public abstract  class GCMNotificationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (!extras.isEmpty()) {
            if (GoogleCloudMessaging.MESSAGE_TYPE_SEND_ERROR
                ...
                //        + datames);
                buildnoti("Message Received from Google GCM Server: "
                        + datames);
    ...
    public abstract void buildnoti(String msg);
}
